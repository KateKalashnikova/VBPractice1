Public Class Form1
    ...
    Private Sub btnMultiplyValues_Click(sender As Object, e As EventArgs) Handles btnMultiplyValues.Click
        Dim firstNum As Decimal = CDec(txtMultValue1.Text)
        Dim secondNum As Decimal = CDec(txtMultValue2.Text)
        Dim intSolution As Integer = CType(firstNum * secondNum, Integer)

        txtMultAnswer.Text = CStr(intSolution)
    End Sub

    Private Sub btnSubstr_Click(sender As Object, e As EventArgs) Handles btnSubstr.Click
        Dim firstNum As Decimal = CDec(txtSubstrValue1.Text)
        Dim secondNum As Decimal = CDec(txtSubstrValue2.Text)
        Dim intSolution As Integer = CType(firstNum - secondNum, Integer)

        txtSubstrAnswer.Text = CStr(intSolution)
    End Sub
